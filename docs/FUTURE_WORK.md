...
- **FW-PRIV-001B — Complete verified customer account deletion:** ADR-0015 is accepted,
  and `FW-PRIV-001A` supplies a disabled public/authenticated request, one-time
